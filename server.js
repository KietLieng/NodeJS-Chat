...
// initiate express module for lightweight web framework for handling wer services
var app = express();
...
function updateNameList() {
  ...
  for (object in clientNames) {
    str += "<li id='" + object + "' class='flagoff' onclick=\"togglePrivate(this);\">" + clientNames[object] + "</li>";
  }
  return str;
}
...
// initiate OS object to interface with network card
